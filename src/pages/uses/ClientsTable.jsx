...
import {getAllUsers, addUser, deleteUserById, editUser, getAllClients} from '../../api/usersApi';
import {
...
const ClientsStable = () => {
    ...
    useEffect(() => {
        fetchClients(); // Изменили вызов функции для получения клиентов
    }, []);

    const fetchClients = async () => {
        setLoading(true);
        try {
            const data = await getAllClients(); // Изменили вызов функции для получения клиентов
    ...
    const onFinish = async (values) => {
        try {
            ...
            fetchClients(); // Запросить обновленный список пользователей
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            fetchClients(); // Запросить обновленный список пользователей после удаления
        } catch (error) {
